...
func (t *Ticket) GetTotalTickets(destination string) int {
...
func (t *Ticket) GetCountByPeriod(time string) (int, error) {
...
func (t *Ticket) AverageDestination(destination string) (float64, error) {
